 ...
 * hands the same object to three restore actions, one per flow that owns a field in it. Nothing else
 * covers those three dispatches, so this holds the app store to the contract: each action picks its
