...
describe("BrazeProvider", () => {
  ...
  it("should update Redux only after the Braze refresh signal", async () => {
    ...
    await act(async () => {
      onContentCardsUpdated({ cards: [desktopCard] } as braze.ContentCards);
    });
  ...
  it("should ignore pre-wipe events and issue a new refresh after an identity reset", async () => {
    ...
    await act(async () => {
      preWipeListener({ cards: [desktopCard] } as braze.ContentCards);
    });
    ...
    await act(async () => {
      postWipeListener({ cards: [desktopCard] } as braze.ContentCards);
