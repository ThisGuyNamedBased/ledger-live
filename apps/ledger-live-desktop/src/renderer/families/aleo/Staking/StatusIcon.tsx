...
/**
 * Green when the position earns, yellow plus the reason when it does not. A staked user
 * earning nothing is the case the screen most needs to call out, so it never renders
 * silently.
 */
const StatusIcon = ({
  nonEarningReason,
