...
/**
 * The position's totals, between the card title and the validator table. Claimable is the
 * part of the unbonding balance the chain will already release, so the two are shown side
 * by side rather than summed — "unstaking" is only what is still waiting.
 */
